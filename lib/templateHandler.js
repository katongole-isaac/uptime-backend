...
templateHandlers.logout = (data, cb) => {
const logoutGlobals = {
  "global.bodyClass": "index",
  "global.title": "Logged Out",
};

getTemplateByName("accountLogout", data, logoutGlobals, cb);

}

templateHandlers.accountEdit = (data, cb) =>  {

  const editPageGlobals = {
    "global.bodyClass": "accountEdit",
    "global.title": "My Account",
  };
getTemplateByName("accountSettings", data, editPageGlobals, cb);
